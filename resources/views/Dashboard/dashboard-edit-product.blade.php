							...
							<div class="wt-dashboardtabs">
								<ul class="wt-tabstitle nav navbar-nav">
									<li class="nav-item" id="add_company">
										<a class="company_tab active" data-toggle="tab" href="#wt-addcompany">Edit Product</a>
									</li>
								</ul>
							</div>
											...
											<div class="wt-formtheme wt-userform">
												<fieldset>
													...
													<div class="form-group form-group-full text-uppercase">
														...
														<input name="post_code" type="text" class="form-control text-capitalize" data-role="tagsinput" placeholder="Post Code">
													</div>
												</fieldset>
											</div>
										</div>
